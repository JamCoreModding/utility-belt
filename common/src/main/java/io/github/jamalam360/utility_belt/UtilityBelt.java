...
public class UtilityBelt {
    ...
    public static final RegistrySupplier<DataComponentType<Integer>> UTILITY_BELT_SIZE_COMPONENT_TYPE = COMPONENT_TYPES.register("utility_belt_size", () -> DataComponentType.<Integer>builder().persistent(Codec.INT).networkSynchronized(ByteBufCodecs.INT).cacheEncoding().build());
